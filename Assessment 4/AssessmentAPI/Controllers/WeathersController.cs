...
namespace AssessmentAPI.Controllers
{
    ...
    public class WeathersController : ControllerBase
    {
        ...
        // GET: api/Weathers
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Weather>>> GetWeatherDetails()
        {
        ...
        {
            var weather = await _context.WeatherDetails.FindAsync(id);
        ...
        {
            _context.WeatherDetails.Add(weather);
            try
            {
                await _context.SaveChangesAsync();
            }
        ...
        public async Task<IActionResult> DeleteWeather(string id)
        {
            ...
            _context.WeatherDetails.Remove(weather);
            await _context.SaveChangesAsync();
